...
public class FundAgentConfiguration {
    ...
    @Bean AgentCapabilityExecutor declineAttributionCapabilityExecutor(FundCatalystResearchTool tool,com.jijing.fund.agent.port.AgentDagRepository dag,com.jijing.fund.agent.graph.GraphCheckpointStore checkpoints,com.fasterxml.jackson.databind.ObjectMapper mapper){return new DeclineAttributionCapabilityGraphExecutor(tool,dag,checkpoints,mapper);}
