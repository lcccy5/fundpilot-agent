...
class FundToolRouterEvaluationTest {
    ...
    @Test void colloquialRecentSectorQuestionUsesScenarioTool(){var sector=mock(SectorOutlookTool.class);var router=new FundToolRouter(mock(FundProfileTool.class),mock(FundNavTool.class),mock(FundMetricsTool.class),mock(FundComparisonTool.class),mock(FundDocumentSearchTool.class),mock(FundRealtimeQuoteTool.class),sector);assertThat(router.toolsFor("机器人板块最近咋样")).containsExactly(sector);}
